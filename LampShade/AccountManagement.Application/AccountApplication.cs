...
namespace AccountManagement.Application
{
    public class AccountApplication : IAccountApplication
    {
        ...
        public OpretionResult ChangePassword(ChangePassword command)
        {
        ...
        public OpretionResult Register(RegisterAccount command)
        {
            var operation = new OpretionResult();
        ...
        public OpretionResult Edit(EditAccount command)
        {
            var operation = new OpretionResult();
            var account = _accountRepository.Get(command.Id);
            if (account == null)
        ...
        public OpretionResult Login(Login command)
        {
            var operation = new OpretionResult();
